 ...
 * @author Admin
 */
public class JD_ThongBaoCapNhat extends javax.swing.JDialog {

    /**
     * Creates new form JD_ThongBaoCapNhat
     */
    public JD_ThongBaoCapNhat(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bạn có muốn cập nhật không?");
    ...
    private void btn_DongYCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_DongYCapNhatActionPerformed
        BienToanCuc_QLHS.luaChonCapNhat=true;
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JD_ThongBaoCapNhat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JD_ThongBaoCapNhat dialog = new JD_ThongBaoCapNhat(new javax.swing.JFrame(), true);
